...
export class Calendar1662222846775 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ALTER TABLE "calendar"
                ADD CONSTRAINT "UQ_f9e74800160ff5ee11d55dc3821" UNIQUE ("calendarId");
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "calendar"
                DROP CONSTRAINT "UQ_f9e74800160ff5ee11d55dc3821"`,
    );
    await queryRunner.query(`DROP TABLE "calendar"`);

    await queryRunner.query(`DROP TYPE "public"."calendar_calendartype_enum"`);
  }
}
